...
const getStreamListBAD = async function () {
    userInput = document.querySelector('#netSearch').value
	var options = {
        method: 'GET',
...
const NetMovieArry = getStreamListBAD('netflix', 'movies');
...
document.querySelector('#searchNetflixButton').addEventListener('click', getStreamListBAD);
